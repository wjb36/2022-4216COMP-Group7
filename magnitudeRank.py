...
if __name__ == '__main__':
    ...
    csv_file_path = "M:/earthquakeDataset.csv"
    ...
    for earthquake in highest_magnitude_earthquakes:
        print(f"Date: {earthquake.date}, Magnitude: {earthquake.magnitude}, Latitude: {earthquake.latitude}, Longitude: {earthquake.longitude}")
